...
public class RefundController {
    ...
    public Map<String, String> askForRefund(@RequestBody Map<String, String> payload)
    {
        ...
        if(T.equals(null) || T.getType().equals("Cash On Delivery"))
        {
        ...
        // system.getSystemHistory().addTransaction(refund);
    ...
    public Map<String, String> reviewRefund(@RequestBody Map<String, String> payload)
    {
        ...
        if(!(acc instanceof Admin)||T.equals(null)|| !(action.equals("accept")||action.equals("reject")))
        {
